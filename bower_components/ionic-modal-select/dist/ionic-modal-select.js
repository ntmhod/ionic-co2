var modalSelectTemplates = modalSelectTemplates || {};modalSelectTemplates['modal-template-multiple.html'] = ' <ion-modal-view class="ionic-select-modal" ng-class="::ui.modalClass">\n' +
    ...
    '        <button class="button button-light" ng-click="closeModal()">{{ui.cancelButton}}</button>\n' +
    '        <h2 class="title"><button class="button">OK</button></h2>\n' +
    '        <button ng-if="::!ui.hideReset" class="button button-light" ng-click="unsetValue()">{{ui.resetButton}}</button>\n' +
    '    </ion-footer-bar>\n' +
    '</ion-modal-view>\n' +
    '';
...
var modalSelectTemplates = modalSelectTemplates || {};modalSelectTemplates['modal-template.html'] = ' <ion-modal-view class="ionic-select-modal" ng-class="::ui.modalClass">\n' +
    ...
    '\n' +
    '    <ion-footer-bar ng-class="::ui.headerFooterClass">\n' +
    '        <button type="button" class="button button-light modal-select-close-button" ng-click="closeModal()">{{ui.cancelButton}}</button>\n' +
    '        <button type="button" ng-if="::!ui.hideReset" class="button button-light" ng-click="unsetValue()">{{ui.resetButton}}</button>\n' +
    '    </ion-footer-bar>\n' +
    '\n' +
    '</ion-modal-view>\n' +
    '';
